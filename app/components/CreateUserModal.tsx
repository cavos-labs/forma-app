...
export default function CreateUserModal({
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.gender) {
      newErrors.gender =
        language === "es" ? "El género es requerido" : "Gender is required";
    }
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div>
              ...
              <input
                ...
                placeholder={
                  language === "es" ? "Ingresa el nombre" : "Enter first name"
                }
              />
              {errors.first_name && (
                <p
          ...
          <div>
            ...
            <input
              ...
              placeholder={
                language === "es" ? "ejemplo@email.com" : "example@email.com"
              }
            />
            {errors.email && (
          ...
          <div>
            ...
            >
              <option value="unspecified">
                {language === "es" ? "No especificado" : "Unspecified"}
              </option>
              <option value="male">
