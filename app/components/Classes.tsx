...
const Classes = forwardRef<ClassesRef, ClassesProps>(({ gymId }, ref) => {
  ...
  const handleSaveWorkout = async () => {
    ...
    if (!workoutText.trim()) {
      showSuccessModal(
        ...
        language === "es"
          ...
          : "Please add content to the workout"
      );
      return;
    }
    ...
    try {
      ...
      if (
        ...
        (response.success || response.workout)
      ) {
  ...
  return (
    <div className="h-full flex flex-col p-3 sm:p-6">
      ...
      {/* Calendar */}
      <div
        className="flex-1 rounded-lg p-2 sm:p-6"
        style={{
          ...
          >
            ...
            <div className="space-y-4 mb-6">
              ...
              {workoutElements.length === 0 && (
                ...
                >
                  {language === "es"
                    ? "Agrega títulos y texto para crear el entrenamiento"
                    : "Add titles and text to create the workout"}
                </div>
              )}
            </div>
          ...
          {isFullscreen && (
            <div className="absolute top-4 right-4 z-10">
              <button
                ...
                className="p-3 rounded-lg bg-gray-800 bg-opacity-80 hover:bg-opacity-100 transition-all backdrop-blur-sm"
                style={{ color: "#ffffff" }}
                title={
                  language === "es"
      ...
      <div className="p-3 sm:p-4 pl-8 sm:pl-10">
        ...
        {element.type === "title" ? (
          <input
            ...
            placeholder={
              language === "es" ? "Título del entrenamiento" : "Workout title"
            }
