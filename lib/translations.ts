export const translations = {
  en: {
    ...
    gymAddressPlaceholder: "123 Main St, City",
    gymPhonePlaceholder: "+506 8888-8888",
    gymEmailPlaceholder: "gym@example.com",
    monthlyFeePlaceholder: "25000",
    ...
    gymManagementCenter: "Gym Management Center",
    ...
    analyticsDesc: "View detailed reports and analytics about your gym",
    accessControl: "Access Control",
    accessControlDesc: "Manage member access and track gym entry logs",
    settings: "Settings",
  ...
  es: {
    ...
    gymNamePlaceholder: "Nombre de tu Gimnasio",
    gymAddressPlaceholder: "Calle 123, Ciudad",
    gymPhonePlaceholder: "+506 8888-8888",
    gymEmailPlaceholder: "gimnasio@ejemplo.com",
    monthlyFeePlaceholder: "25000",
    sinpePhonePlaceholder: "88888888",
    ...
    feature1: "Gestión completa de membresías",
    feature2: "Pagos SINPE automatizados",
    feature3: "Análisis y reportes en tiempo real",
    feature4: "Sistema de control de acceso",
    feature5: "Soporte al cliente",
    ...
    welcomeToDashboard: "Bienvenido a tu Dashboard",
    gymManagementCenter: "Centro de Gestión del Gimnasio",
